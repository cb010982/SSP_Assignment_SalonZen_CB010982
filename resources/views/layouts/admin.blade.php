        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="{{asset('dasboard/assets/images/faces/face15.jpg')}}" alt="">
                  <span class="count bg-success"></span>
                </div>
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Admin02</h5>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('admin.products.index') }}">
              ...
              <span class="menu-title">Manage poducts</span>
            </a>
          </li>
          <li class="nav-item menu-items">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    ...
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Admin02</p> 
